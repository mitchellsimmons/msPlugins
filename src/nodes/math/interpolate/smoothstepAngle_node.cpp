#include "smoothstepAngle_node.h"

// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------

SmoothstepAngle::SmoothstepAngle() {}
SmoothstepAngle::~SmoothstepAngle() {}

// ------ Attr ------
MObject SmoothstepAngle::input1Attr;
MObject SmoothstepAngle::input2Attr;
MObject SmoothstepAngle::tAttr;
MObject SmoothstepAngle::outputAttr;

// ------ MPxNode ------
MPxNode::SchedulingType SmoothstepAngle::schedulingType() const
{
	return SchedulingType::kParallel;
}

MStatus SmoothstepAngle::initialize()
{
...
MStatus SmoothstepAngle::compute(const MPlug& plug, MDataBlock& dataBlock)
{
	if (plug != outputAttr)
