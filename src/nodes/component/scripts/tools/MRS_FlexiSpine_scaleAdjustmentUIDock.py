...
_scaleAdjustmentDockName = "MRS_FlexiSpine_ScaleAdjustmentUI_WorkspaceControl"
_scaleAdjustmentWindowName = "MRS_FlexiSpine_ScaleAjustmentUI"
...
def scaleAdjustmentDockUI():
    ...
    if _scaleAdjustmentDockWidget is None:
        ...
        if not cmds.workspaceControl(_scaleAdjustmentDockName, q = True, exists = True):
            ...
            uiScript = "import MRS_FlexiSpine_scaleAdjustmentUIDock\nMRS_FlexiSpine_scaleAdjustmentUIDock.scaleAdjustmentDockUIScript()"
    ...
    # Seems like the docked/undocked heights behave slightly different
