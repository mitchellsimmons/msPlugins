...
_scaleAdjustmentDockName = "MRS_FlexiChainDouble_ScaleAdjustmentUI_WorkspaceControl"
_scaleAdjustmentWindowName = "MRS_FlexiChainDouble_ScaleAjustmentUI"
...
def scaleAdjustmentDockUI():
    ...
    if _scaleAdjustmentDockWidget is None:
        ...
        if not cmds.workspaceControl(_scaleAdjustmentDockName, q = True, exists = True):
            ...
            uiScript = "import MRS_FlexiChainDouble_scaleAdjustmentUIDock\nMRS_FlexiChainDouble_scaleAdjustmentUIDock.scaleAdjustmentDockUIScript()"
