...
class FlexiSpine_TwistAdjustmentManip : public MPxManipulatorNode
{
public:
	FlexiSpine_TwistAdjustmentManip();
	~FlexiSpine_TwistAdjustmentManip() override;
...
private:
	friend class FlexiSpine_TwistAdjustmentContext;

	// ------ Data ------
	FlexiSpine* m_locator;
...
class FlexiSpine_TwistAdjustmentManipContainer : public MPxManipContainer
{
public:
	FlexiSpine_TwistAdjustmentManipContainer();
	~FlexiSpine_TwistAdjustmentManipContainer() override;
...
private:
	...
	// ------ Data ------
	FlexiSpine_TwistAdjustmentManip* m_manip;
	FlexiSpine* m_locator;
	MDagPath m_locatorPath;
};
...
class FlexiSpine_TwistAdjustmentContext : public MPxSelectionContext
{
public:
	FlexiSpine_TwistAdjustmentContext();
	~FlexiSpine_TwistAdjustmentContext() override;
...
private:
	...
	std::vector<FlexiSpine_TwistAdjustmentManipContainer*> m_manipContainers;
};

// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------

// Class defines a command that will be used to create a single instance of the above context
class FlexiSpine_TwistAdjustmentContextCommand : public MPxContextCommand
{
public:
	FlexiSpine_TwistAdjustmentContextCommand();
	~FlexiSpine_TwistAdjustmentContextCommand() override;
...
private:
	// ------ Data ------
	FlexiSpine_TwistAdjustmentContext* m_context;
};
