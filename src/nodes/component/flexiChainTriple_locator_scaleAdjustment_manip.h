...
class FlexiChainTriple_ScaleAdjustmentManip : public MPxManipulatorNode
{
public:
	FlexiChainTriple_ScaleAdjustmentManip();
	~FlexiChainTriple_ScaleAdjustmentManip() override;
...
private:
	friend class FlexiChainTriple_ScaleAdjustmentContext;
...
class FlexiChainTriple_ScaleAdjustmentManipContainer : public MPxManipContainer
{
public:
	FlexiChainTriple_ScaleAdjustmentManipContainer();
	~FlexiChainTriple_ScaleAdjustmentManipContainer() override;
...
private:
	...
	// ------ Data ------
	FlexiChainTriple_ScaleAdjustmentManip* m_manip;
	FlexiChainTriple* m_locator;
	MDagPath m_locatorPath;
};
...
class FlexiChainTriple_ScaleAdjustmentContext : public MPxSelectionContext
{
public:
	FlexiChainTriple_ScaleAdjustmentContext();
	~FlexiChainTriple_ScaleAdjustmentContext() override;
...
private:
	...
	std::vector<FlexiChainTriple_ScaleAdjustmentManipContainer*> m_manipContainers;
};

// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------

// Class defines a command that will be used to create a single instance of the above context
class FlexiChainTriple_ScaleAdjustmentContextCommand : public MPxContextCommand
{
public:
	FlexiChainTriple_ScaleAdjustmentContextCommand();
	~FlexiChainTriple_ScaleAdjustmentContextCommand() override;
...
private:
	// ------ Data ------
	FlexiChainTriple_ScaleAdjustmentContext* m_context;
};
