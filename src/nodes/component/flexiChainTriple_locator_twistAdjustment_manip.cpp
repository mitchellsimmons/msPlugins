...
FlexiChainTriple_TwistAdjustmentManip::FlexiChainTriple_TwistAdjustmentManip() : MPxManipulatorNode(),
	m_locator{ nullptr },
	m_physicalIndex{ 0 },
...
FlexiChainTriple_TwistAdjustmentManip::~FlexiChainTriple_TwistAdjustmentManip()
{
	m_locator = nullptr;
}

// Static
unsigned int FlexiChainTriple_TwistAdjustmentManip::physicalIndex = 0;
const MDistance FlexiChainTriple_TwistAdjustmentManip::m_offsetHandleRadius{ 1.2, MDistance::kCentimeters };
const double FlexiChainTriple_TwistAdjustmentManip::m_offsetHandleDragIncrement = 0.001;

// ------ MPxNode------

void FlexiChainTriple_TwistAdjustmentManip::postConstructor()
{
...
MStatus FlexiChainTriple_TwistAdjustmentManip::initialize()
{
	// No-op
	return MS::kSuccess;
}
...
MStatus FlexiChainTriple_TwistAdjustmentManip::connectToDependNode(const MObject& node)
{
	MStatus status;
...
void FlexiChainTriple_TwistAdjustmentManip::preDrawUI(const M3dView& view)
{
...
void FlexiChainTriple_TwistAdjustmentManip::drawUI(MHWRender::MUIDrawManager& drawManager, const MHWRender::MFrameContext& frameContext) const
{
...
MStatus FlexiChainTriple_TwistAdjustmentManip::doPress(M3dView& view)
{
	if (glActiveName(m_activeName))
	{
		if (m_activeName == m_handleName)
		{
			...
			MString activePlugCmd = "FlexiChainTripleTwistAdjustmentContext -e -activeManipPlug " + getCompoundPlugPartialName();
			activePlugCmd += " FlexiChainTripleTwistAdjustmentContext1";
			MGlobal::executeCommand(activePlugCmd);

			// Update the ramp UI if it exists and is visible (see MRS_FlexiChainTriple_twistAdjustmentUIReplace.mel for implementation)
			...
			MString updateUICmd = "MRS_FlexiChainTriple_twistAdjustmentUIReplace " + getCompoundPlugPartialName();
...
MStatus FlexiChainTriple_TwistAdjustmentManip::doDrag(M3dView& view)
{
	MStatus status;
...
MStatus FlexiChainTriple_TwistAdjustmentManip::doRelease(M3dView& view)
{
...
MStatus FlexiChainTriple_TwistAdjustmentManip::doMove(M3dView& view, bool& refresh)
{
	MPoint pCameraWorld = getCameraPosition(view);
...
MStatus FlexiChainTriple_TwistAdjustmentManip::getCompoundPlug(MPlug& compoundPlug)
{
	MStatus status;

	MPlug compoundArrayPlug{ m_locatorPath.node(), FlexiChainTriple::twistAdjustmentCompoundAttr };
...
MStatus FlexiChainTriple_TwistAdjustmentManip::getRampCompoundPlug(MPlug& rampPlug)
{
	MStatus status;
	...
	if (status)
		rampPlug = compoundPlug.child(FlexiChainTriple::twistAdjustmentRampAttr, &status);
...
MStatus FlexiChainTriple_TwistAdjustmentManip::getTwistPlug(MPlug& twistPlug)
{
	MStatus status;
	...
	status = getCompoundPlug(compoundPlug);
	if (status)
		twistPlug = compoundPlug.child(FlexiChainTriple::twistAdjustmentValueAttr, &status);
...
MStatus FlexiChainTriple_TwistAdjustmentManip::getOffsetPlug(MPlug& offsetPlug)
{
	MStatus status;
	...
	status = getCompoundPlug(compoundPlug);
	if (status)
		offsetPlug = compoundPlug.child(FlexiChainTriple::twistAdjustmentOffsetAttr, &status);
...
MString FlexiChainTriple_TwistAdjustmentManip::getCompoundPlugPartialName()
{
...
bool FlexiChainTriple_TwistAdjustmentManip::isUserInteracting()
{
	return m_isUserInteracting;
}

bool FlexiChainTriple_TwistAdjustmentManip::isMouseHovered()
{
	return m_isMouseHovered;
}

bool FlexiChainTriple_TwistAdjustmentManip::isActive()
{
	return m_isActive;
}
...
MPoint FlexiChainTriple_TwistAdjustmentManip::sampleCurve(double param)
{
	MPoint pPosition;
...
MPoint FlexiChainTriple_TwistAdjustmentManip::getCameraPosition(M3dView& view) const
{
	MDagPath cameraPath;
...
// VP2 implementation
MPoint FlexiChainTriple_TwistAdjustmentManip::getCameraPosition(const MHWRender::MFrameContext& frameContext) const
{
...
// Legacy implementation
MVector FlexiChainTriple_TwistAdjustmentManip::getCameraAimDirection(M3dView& view) const
{
	MDagPath cameraPath;
	view.getCamera(cameraPath);
	cameraPath.pop();
...
// VP2 implementation
MVector FlexiChainTriple_TwistAdjustmentManip::getCameraAimDirection(const MHWRender::MFrameContext& frameContext) const
{
...
// Legacy implementation
MVector FlexiChainTriple_TwistAdjustmentManip::getCameraUpDirection(M3dView& view) const
{
	MDagPath cameraPath;
	view.getCamera(cameraPath);
	cameraPath.pop();
...
// VP2 implementation
MVector FlexiChainTriple_TwistAdjustmentManip::getCameraUpDirection(const MHWRender::MFrameContext& frameContext) const
{
...
bool FlexiChainTriple_TwistAdjustmentManip::computeMouseIntersection(const MPoint& pMouse, const MVector& vMouseDirection, const MPoint& pPointOnInterPlane,
...
/*	Description
	...
	Returns true if the raycast produces a successful intersection    */
bool FlexiChainTriple_TwistAdjustmentManip::computeCurrentMouseIntersection(const MPoint& pPointOnInterPlane, const MVector& vInterPlaneNormal, MPoint& pIntersection)
{
...
void FlexiChainTriple_TwistAdjustmentManip::updateOffsetHandle()
{
...
MStatus FlexiChainTriple_TwistAdjustmentManip::updateOffsetHandlePlug(double offset)
{
	MStatus status;
...
FlexiChainTriple_TwistAdjustmentManipContainer::FlexiChainTriple_TwistAdjustmentManipContainer() : MPxManipContainer(),
	m_manip{ nullptr },
	m_locator{ nullptr }
{}

FlexiChainTriple_TwistAdjustmentManipContainer::~FlexiChainTriple_TwistAdjustmentManipContainer()
{
	m_manip = nullptr;
	m_locator = nullptr;
}
...
MStatus FlexiChainTriple_TwistAdjustmentManipContainer::initialize()
{
	return MPxManipContainer::initialize();
}

MStatus FlexiChainTriple_TwistAdjustmentManipContainer::createChildren()
{
	MStatus status;
	
	MPxManipulatorNode *proxyManip = 0;
	MString manipTypeName(FlexiChainTriple_TwistAdjustmentManip::kTypeName);
	MString manipName("FlexiChainTripleTwistAdjustmentManipInst");
	status = addMPxManipulatorNode(manipTypeName, manipName, proxyManip);

	if (status)
		m_manip = (FlexiChainTriple_TwistAdjustmentManip*)proxyManip;

	return status;
}

MStatus FlexiChainTriple_TwistAdjustmentManipContainer::connectToDependNode(const MObject& node)
{
	MStatus status;
...
FlexiChainTriple_TwistAdjustmentContext::FlexiChainTriple_TwistAdjustmentContext() : MPxSelectionContext(),
	m_numActiveNodes{ 0 },
	m_selectionChangedCallbackId{ 0 }
{
	MString titleStr("FlexiChainTriple Twist Adjustment Tool");
	setTitleString(titleStr);
}

FlexiChainTriple_TwistAdjustmentContext::~FlexiChainTriple_TwistAdjustmentContext() {}
...
void FlexiChainTriple_TwistAdjustmentContext::toolOnSetup(MEvent& event)
{
	MStatus status;
	...
	if (!status)
		std::cerr << "FlexiChainTriple_TwistAdjustmentContext: MEventMessage::addEventCallback() failed" << std::endl;
...
void FlexiChainTriple_TwistAdjustmentContext::toolOffCleanup()
{
	MStatus status;
	...
	if (!status)
		cerr << "FlexiChainTriple_TwistAdjustmentContext: MNodeMessage::removeCallback() failed" << std::endl;
	m_selectionChangedCallbackId = 0;
...
MStatus FlexiChainTriple_TwistAdjustmentContext::doEnterRegion(MEvent& event)
{
	MString helpStr("Drag manipulators to define the offset for each twist adjustment falloff. Right click for more options.");
...
MStatus FlexiChainTriple_TwistAdjustmentContext::drawFeedback(MHWRender::MUIDrawManager& drawManager, const MHWRender::MFrameContext& frameContext)
{
	...
	if (m_numActiveNodes == 1)
		text = ("FlexiChainTriple  :  Twist Adjustment Tool  :  " + activeItems) + " Active Node";
	else
		text = ("FlexiChainTriple  :  Twist Adjustment Tool  :  " + activeItems) + " Active Nodes";
...
MString FlexiChainTriple_TwistAdjustmentContext::getHoverManipPlug()
{
	for (FlexiChainTriple_TwistAdjustmentManipContainer*& manipContainer : m_manipContainers)
	{
...
MString FlexiChainTriple_TwistAdjustmentContext::getActiveManipPlug()
{
	for (FlexiChainTriple_TwistAdjustmentManipContainer*& manipContainer : m_manipContainers)
	{
...
void FlexiChainTriple_TwistAdjustmentContext::setActiveManipPlug(MString& activeManipPlugName)
{
	MStatus status;
...
void FlexiChainTriple_TwistAdjustmentContext::updateManipulatorsCallback(void* data)
{
	MStatus status;

	FlexiChainTriple_TwistAdjustmentContext* context = (FlexiChainTriple_TwistAdjustmentContext*)data;
	...
	while (!iter.isDone())
	{
		...
		if (!seen && fnDep.typeId() == FlexiChainTriple::kTypeId)
		{
			...
			{
				FlexiChainTriple_TwistAdjustmentManip::physicalIndex = i;
				MString manipName(FlexiChainTriple_TwistAdjustmentManipContainer::kTypeName);
				MObject manipObject = MObject::kNullObj;
				FlexiChainTriple_TwistAdjustmentManipContainer* manipContainer = (FlexiChainTriple_TwistAdjustmentManipContainer*)FlexiChainTriple_TwistAdjustmentManipContainer::newManipulator(manipName, manipObject);
			...
			if (status)
				...
				std::cerr << "FlexiChainTriple_TwistAdjustmentContext: MNodeMessage::addAttributeChangedCallback() failed" << std::endl;
		}
...
void FlexiChainTriple_TwistAdjustmentContext::nodePlugChangedCallback(MNodeMessage::AttributeMessage msg, MPlug& plug, MPlug& otherPlug, void* data)
{
	...
	if (msg & MNodeMessage::AttributeMessage::kAttributeEval)
	{
			...
			plug == FlexiChainTriple::outputWorldPositionsAttr || plug == FlexiChainTriple::outputWorldOrientationsAttr)
		{
			...
			FlexiChainTriple_TwistAdjustmentContext* context = (FlexiChainTriple_TwistAdjustmentContext*)data;
			for (FlexiChainTriple_TwistAdjustmentManipContainer*& manipContainer : context->m_manipContainers)
			{
...
/*	Description
	-----------
	The FlexiChainTripleTwistAdjustmentContext command is used to generate a custom context which can then be used to modify twist adjustments
	- A manipulator is created for each twistAdjustment element plug, on each selected FlexiChainTriple node assigned to the active context
	- This command allows the user to query certain states relating to those manipulators

	MEL Command
	-----------
	FlexiChainTripleTwistAdjustmentContext [-hoverManipPlug bool] [-activeManipPlug bool] [context]
	...
	----
	context
		This is the name given to the FlexiChainTripleTwistAdjustmentContext instance upon creation
		When querying the active context, this name must be passed to the command
*/

FlexiChainTriple_TwistAdjustmentContextCommand::FlexiChainTriple_TwistAdjustmentContextCommand() : MPxContextCommand(),
	m_context{ nullptr }
{}

FlexiChainTriple_TwistAdjustmentContextCommand::~FlexiChainTriple_TwistAdjustmentContextCommand()
{
	m_context = nullptr;
}
...
const char* FlexiChainTriple_TwistAdjustmentContextCommand::kHoverFlag = "-hmp";
const char* FlexiChainTriple_TwistAdjustmentContextCommand::kHoverFlagLong = "-hoverManipPlug";
const char* FlexiChainTriple_TwistAdjustmentContextCommand::kActiveFlag = "-amp";
const char* FlexiChainTriple_TwistAdjustmentContextCommand::kActiveFlagLong = "-activeManipPlug";

MPxContext* FlexiChainTriple_TwistAdjustmentContextCommand::makeObj()
{
	m_context = new FlexiChainTriple_TwistAdjustmentContext;
	return m_context;
}

MStatus FlexiChainTriple_TwistAdjustmentContextCommand::doEditFlags()
{
	MStatus status;
...
MStatus FlexiChainTriple_TwistAdjustmentContextCommand::doQueryFlags()
{
	MStatus status;
	MArgParser argParser = parser();
...
MStatus FlexiChainTriple_TwistAdjustmentContextCommand::appendSyntax()
{
	MStatus status;
