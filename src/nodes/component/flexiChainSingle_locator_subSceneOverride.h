...
// Class is used to implement viewport 2.0 support for drawing of the FlexiChainSingleShape
class FlexiChainSingle_SubSceneOverride : public MHWRender::MPxSubSceneOverride
{
public:
	FlexiChainSingle_SubSceneOverride(const MObject& obj);
	~FlexiChainSingle_SubSceneOverride();
