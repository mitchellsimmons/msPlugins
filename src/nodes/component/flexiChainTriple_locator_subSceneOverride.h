...
// Class is used to implement viewport 2.0 support for drawing of the FlexiChainTripleShape
class FlexiChainTriple_SubSceneOverride : public MHWRender::MPxSubSceneOverride
{
public:
	FlexiChainTriple_SubSceneOverride(const MObject& obj);
	~FlexiChainTriple_SubSceneOverride();
