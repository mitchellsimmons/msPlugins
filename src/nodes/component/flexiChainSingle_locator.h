...
// Node models a cubic Bezier curve with two shaping parameters
// It is driven by three physical points which are translated into four virtual points
class FlexiChainSingle : public MPxLocatorNode, MRS::NodeHelper
{
public:
	// ------ Data ------
	// Class designed to encapsulate data for FlexiChainSingle objects
	// Data is updated whenever the node evaluates
	class FlexiChainSingle_Data
	{
	private:
		friend class FlexiChainSingle;
		FlexiChainSingle_Data();
		~FlexiChainSingle_Data();
...
public:
	...
	const FlexiChainSingle_Data& getCurveData() const;
	...
	static MObject jointOffsetAttr;
	static MObject jointRadiusAttr;
	static MObject jointVolumeAttr;
...
class FlexiChainSingle_CounterTwistCommand : public MPxCommand
{
public:
	FlexiChainSingle_CounterTwistCommand();
	~FlexiChainSingle_CounterTwistCommand() override;
...
class FlexiChainSingle_StabilityCommand : public MPxCommand
{
public:
	FlexiChainSingle_StabilityCommand();
	~FlexiChainSingle_StabilityCommand() override;
