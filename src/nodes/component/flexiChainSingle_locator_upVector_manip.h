...
class FlexiChainSingle_UpVectorManip : public MPxManipulatorNode
{
public:
	FlexiChainSingle_UpVectorManip();
	~FlexiChainSingle_UpVectorManip() override;
...
private:
	friend class FlexiChainSingle_UpVectorContext;
...
class FlexiChainSingle_UpVectorManipContainer : public MPxManipContainer
{
public:
	FlexiChainSingle_UpVectorManipContainer();
	~FlexiChainSingle_UpVectorManipContainer() override;
...
private:
	...
	// ------ Data ------
	FlexiChainSingle_UpVectorManip* m_manip;
	FlexiChainSingle* m_locator;
	MDagPath m_locatorPath;
};
...
class FlexiChainSingle_UpVectorContext : public MPxSelectionContext
{
public:
	FlexiChainSingle_UpVectorContext();
	~FlexiChainSingle_UpVectorContext() override;
...
private:
	...
	std::vector<FlexiChainSingle_UpVectorManipContainer*> m_manipContainers;
};

// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------

// Class defines a command that will be used to create a single instance of the above context
class FlexiChainSingle_UpVectorContextCommand : public MPxContextCommand
{
public:
	FlexiChainSingle_UpVectorContextCommand();
	~FlexiChainSingle_UpVectorContextCommand() override;
...
private:
	// ------ Data ------
	FlexiChainSingle_UpVectorContext* m_context;
};
