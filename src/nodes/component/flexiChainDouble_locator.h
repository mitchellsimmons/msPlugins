...
// Node models two cubic Bezier curves, each with two shaping parameters
// It is driven by four physical points which are translated into six virtual points
class FlexiChainDouble : public MPxLocatorNode, MRS::NodeHelper
{
public:
	// ------ Data ------
	// Class designed to encapsulate data for FlexiChainDouble objects
	// Data is updated whenever the node evaluates
	class FlexiChainDouble_Data
	{
	private:
		friend class FlexiChainDouble;
		FlexiChainDouble_Data();
		~FlexiChainDouble_Data();
...
public:
	...
	const FlexiChainDouble_Data& getCurveData() const;
...
class FlexiChainDouble_CounterTwistCommand : public MPxCommand
{
public:
	FlexiChainDouble_CounterTwistCommand();
	~FlexiChainDouble_CounterTwistCommand() override;
...
class FlexiChainDouble_StabilityCommand : public MPxCommand
{
public:
	FlexiChainDouble_StabilityCommand();
	~FlexiChainDouble_StabilityCommand() override;
