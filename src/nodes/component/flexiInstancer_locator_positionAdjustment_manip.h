...
class FlexiInstancer_PositionAdjustmentManip : public MPxManipulatorNode
{
public:
	FlexiInstancer_PositionAdjustmentManip();
	~FlexiInstancer_PositionAdjustmentManip() override;
	...
	MStatus getPositionPlug(MPlug& scalePlug);
...
private:
	friend class FlexiInstancer_PositionAdjustmentContext;
...
class FlexiInstancer_PositionAdjustmentManipContainer : public MPxManipContainer
{
public:
	FlexiInstancer_PositionAdjustmentManipContainer();
	~FlexiInstancer_PositionAdjustmentManipContainer() override;
...
private:
	...
	// ------ Data ------
	FlexiInstancer_PositionAdjustmentManip* m_manip;
	FlexiInstancer* m_locator;
	MDagPath m_locatorPath;
};
...
class FlexiInstancer_PositionAdjustmentContext : public MPxSelectionContext
{
public:
	FlexiInstancer_PositionAdjustmentContext();
	~FlexiInstancer_PositionAdjustmentContext() override;
...
private:
	...
	std::vector<FlexiInstancer_PositionAdjustmentManipContainer*> m_manipContainers;
};

// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------

// Class defines a command that will be used to create a single instance of the above context
class FlexiInstancer_PositionAdjustmentContextCommand : public MPxContextCommand
{
public:
	FlexiInstancer_PositionAdjustmentContextCommand();
	~FlexiInstancer_PositionAdjustmentContextCommand() override;
...
private:
	// ------ Data ------
	FlexiInstancer_PositionAdjustmentContext* m_context;
};
