...
class FlexiInstancer_ScaleAdjustmentManip : public MPxManipulatorNode
{
public:
	FlexiInstancer_ScaleAdjustmentManip();
	~FlexiInstancer_ScaleAdjustmentManip() override;
...
private:
	friend class FlexiInstancer_ScaleAdjustmentContext;
...
class FlexiInstancer_ScaleAdjustmentManipContainer : public MPxManipContainer
{
public:
	FlexiInstancer_ScaleAdjustmentManipContainer();
	~FlexiInstancer_ScaleAdjustmentManipContainer() override;
...
private:
	...
	// ------ Data ------
	FlexiInstancer_ScaleAdjustmentManip* m_manip;
	FlexiInstancer* m_locator;
	MDagPath m_locatorPath;
};
...
class FlexiInstancer_ScaleAdjustmentContext : public MPxSelectionContext
{
public:
	FlexiInstancer_ScaleAdjustmentContext();
	~FlexiInstancer_ScaleAdjustmentContext() override;
...
private:
	...
	std::vector<FlexiInstancer_ScaleAdjustmentManipContainer*> m_manipContainers;
};

// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------

// Class defines a command that will be used to create a single instance of the above context
class FlexiInstancer_ScaleAdjustmentContextCommand : public MPxContextCommand
{
public:
	FlexiInstancer_ScaleAdjustmentContextCommand();
	~FlexiInstancer_ScaleAdjustmentContextCommand() override;
...
private:
	// ------ Data ------
	FlexiInstancer_ScaleAdjustmentContext* m_context;
};
