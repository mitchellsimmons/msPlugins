...
class FlexiChainSingle_TwistAdjustmentManip : public MPxManipulatorNode
{
public:
	FlexiChainSingle_TwistAdjustmentManip();
	~FlexiChainSingle_TwistAdjustmentManip() override;
...
private:
	friend class FlexiChainSingle_TwistAdjustmentContext;
...
class FlexiChainSingle_TwistAdjustmentManipContainer : public MPxManipContainer
{
public:
	FlexiChainSingle_TwistAdjustmentManipContainer();
	~FlexiChainSingle_TwistAdjustmentManipContainer() override;
...
private:
	...
	// ------ Data ------
	FlexiChainSingle_TwistAdjustmentManip* m_manip;
	FlexiChainSingle* m_locator;
	MDagPath m_locatorPath;
};
...
class FlexiChainSingle_TwistAdjustmentContext : public MPxSelectionContext
{
public:
	FlexiChainSingle_TwistAdjustmentContext();
	~FlexiChainSingle_TwistAdjustmentContext() override;
...
private:
	...
	std::vector<FlexiChainSingle_TwistAdjustmentManipContainer*> m_manipContainers;
};

// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------

// Class defines a command that will be used to create a single instance of the above context
class FlexiChainSingle_TwistAdjustmentContextCommand : public MPxContextCommand
{
public:
	FlexiChainSingle_TwistAdjustmentContextCommand();
	~FlexiChainSingle_TwistAdjustmentContextCommand() override;
...
private:
	// ------ Data ------
	FlexiChainSingle_TwistAdjustmentContext* m_context;
};
