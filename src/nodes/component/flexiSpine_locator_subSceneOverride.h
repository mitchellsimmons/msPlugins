...
// Class is used to implement viewport 2.0 support for drawing of the FlexiSpineShape
class FlexiSpine_SubSceneOverride : public MHWRender::MPxSubSceneOverride
{
public:
	FlexiSpine_SubSceneOverride(const MObject& obj);
	~FlexiSpine_SubSceneOverride();
