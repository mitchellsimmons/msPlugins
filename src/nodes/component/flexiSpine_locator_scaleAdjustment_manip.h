...
class FlexiSpine_ScaleAdjustmentManip : public MPxManipulatorNode
{
public:
	FlexiSpine_ScaleAdjustmentManip();
	~FlexiSpine_ScaleAdjustmentManip() override;
...
private:
	friend class FlexiSpine_ScaleAdjustmentContext;
...
class FlexiSpine_ScaleAdjustmentManipContainer : public MPxManipContainer
{
public:
	FlexiSpine_ScaleAdjustmentManipContainer();
	~FlexiSpine_ScaleAdjustmentManipContainer() override;
...
private:
	...
	// ------ Data ------
	FlexiSpine_ScaleAdjustmentManip* m_manip;
	FlexiSpine* m_locator;
	MDagPath m_locatorPath;
};
...
class FlexiSpine_ScaleAdjustmentContext : public MPxSelectionContext
{
public:
	FlexiSpine_ScaleAdjustmentContext();
	~FlexiSpine_ScaleAdjustmentContext() override;
...
private:
	...
	std::vector<FlexiSpine_ScaleAdjustmentManipContainer*> m_manipContainers;
};

// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------

// Class defines a command that will be used to create a single instance of the above context
class FlexiSpine_ScaleAdjustmentContextCommand : public MPxContextCommand
{
public:
	FlexiSpine_ScaleAdjustmentContextCommand();
	~FlexiSpine_ScaleAdjustmentContextCommand() override;
...
private:
	// ------ Data ------
	FlexiSpine_ScaleAdjustmentContext* m_context;
};
