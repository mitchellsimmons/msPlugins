...
// Class is used to implement viewport 2.0 support for drawing of the FlexiInstancerShape
class FlexiInstancer_SubSceneOverride : public MHWRender::MPxSubSceneOverride
{
public:
	FlexiInstancer_SubSceneOverride(const MObject& obj);
	~FlexiInstancer_SubSceneOverride();
...
private:
	...
	void updateRampTexturePositionAdjustmentContext();
