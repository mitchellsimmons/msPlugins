...
class FlexiChainTriple_UpVectorManip : public MPxManipulatorNode
{
public:
	FlexiChainTriple_UpVectorManip();
	~FlexiChainTriple_UpVectorManip() override;
...
private:
	friend class FlexiChainTriple_UpVectorContext;
...
class FlexiChainTriple_UpVectorManipContainer : public MPxManipContainer
{
public:
	FlexiChainTriple_UpVectorManipContainer();
	~FlexiChainTriple_UpVectorManipContainer() override;
...
private:
	...
	// ------ Data ------
	FlexiChainTriple_UpVectorManip* m_manip;
	FlexiChainTriple* m_locator;
	MDagPath m_locatorPath;
};
...
class FlexiChainTriple_UpVectorContext : public MPxSelectionContext
{
public:
	FlexiChainTriple_UpVectorContext();
	~FlexiChainTriple_UpVectorContext() override;
...
private:
	...
	std::vector<FlexiChainTriple_UpVectorManipContainer*> m_manipContainers;
};

// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------

// Class defines a command that will be used to create a single instance of the above context
class FlexiChainTriple_UpVectorContextCommand : public MPxContextCommand
{
public:
	FlexiChainTriple_UpVectorContextCommand();
	~FlexiChainTriple_UpVectorContextCommand() override;
...
private:
	// ------ Data ------
	FlexiChainTriple_UpVectorContext* m_context;
};
