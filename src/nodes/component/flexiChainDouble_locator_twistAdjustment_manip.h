...
class FlexiChainDouble_TwistAdjustmentManip : public MPxManipulatorNode
{
public:
	FlexiChainDouble_TwistAdjustmentManip();
	~FlexiChainDouble_TwistAdjustmentManip() override;
...
private:
	friend class FlexiChainDouble_TwistAdjustmentContext;
...
class FlexiChainDouble_TwistAdjustmentManipContainer : public MPxManipContainer
{
public:
	FlexiChainDouble_TwistAdjustmentManipContainer();
	~FlexiChainDouble_TwistAdjustmentManipContainer() override;
...
private:
	...
	// ------ Data ------
	FlexiChainDouble_TwistAdjustmentManip* m_manip;
	FlexiChainDouble* m_locator;
	MDagPath m_locatorPath;
};
...
class FlexiChainDouble_TwistAdjustmentContext : public MPxSelectionContext
{
public:
	FlexiChainDouble_TwistAdjustmentContext();
	~FlexiChainDouble_TwistAdjustmentContext() override;
...
private:
	...
	std::vector<FlexiChainDouble_TwistAdjustmentManipContainer*> m_manipContainers;
};

// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------

// Class defines a command that will be used to create a single instance of the above context
class FlexiChainDouble_TwistAdjustmentContextCommand : public MPxContextCommand
{
public:
	FlexiChainDouble_TwistAdjustmentContextCommand();
	~FlexiChainDouble_TwistAdjustmentContextCommand() override;
...
private:
	// ------ Data ------
	FlexiChainDouble_TwistAdjustmentContext* m_context;
};
