...
class FlexiChainSingle_ScaleAdjustmentManip : public MPxManipulatorNode
{
public:
	FlexiChainSingle_ScaleAdjustmentManip();
	~FlexiChainSingle_ScaleAdjustmentManip() override;
...
private:
	friend class FlexiChainSingle_ScaleAdjustmentContext;

	// ------ Data ------
	FlexiChainSingle* m_locator;
...
class FlexiChainSingle_ScaleAdjustmentManipContainer : public MPxManipContainer
{
public:
	FlexiChainSingle_ScaleAdjustmentManipContainer();
	~FlexiChainSingle_ScaleAdjustmentManipContainer() override;
...
private:
	...
	// ------ Data ------
	FlexiChainSingle_ScaleAdjustmentManip* m_manip;
	FlexiChainSingle* m_locator;
	MDagPath m_locatorPath;
};
...
class FlexiChainSingle_ScaleAdjustmentContext : public MPxSelectionContext
{
public:
	FlexiChainSingle_ScaleAdjustmentContext();
	~FlexiChainSingle_ScaleAdjustmentContext() override;
...
private:
	...
	std::vector<FlexiChainSingle_ScaleAdjustmentManipContainer*> m_manipContainers;
};

// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------

// Class defines a command that will be used to create a single instance of the above context
class FlexiChainSingle_ScaleAdjustmentContextCommand : public MPxContextCommand
{
public:
	FlexiChainSingle_ScaleAdjustmentContextCommand();
	~FlexiChainSingle_ScaleAdjustmentContextCommand() override;
...
private:
	// ------ Data ------
	FlexiChainSingle_ScaleAdjustmentContext* m_context;
};
