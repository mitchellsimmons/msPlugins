...
class FlexiInstancer_UpVectorManip : public MPxManipulatorNode
{
public:
	FlexiInstancer_UpVectorManip();
	~FlexiInstancer_UpVectorManip() override;
...
private:
	friend class FlexiInstancer_UpVectorContext;
...
class FlexiInstancer_UpVectorManipContainer : public MPxManipContainer
{
public:
	FlexiInstancer_UpVectorManipContainer();
	~FlexiInstancer_UpVectorManipContainer() override;
...
private:
	...
	// ------ Data ------
	FlexiInstancer_UpVectorManip* m_manip;
	FlexiInstancer* m_locator;
	MDagPath m_locatorPath;
};
...
class FlexiInstancer_UpVectorContext : public MPxSelectionContext
{
public:
	FlexiInstancer_UpVectorContext();
	~FlexiInstancer_UpVectorContext() override;
...
private:
	...
	std::vector<FlexiInstancer_UpVectorManipContainer*> m_manipContainers;
};

// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------

// Class defines a command that will be used to create a single instance of the above context
class FlexiInstancer_UpVectorContextCommand : public MPxContextCommand
{
public:
	FlexiInstancer_UpVectorContextCommand();
	~FlexiInstancer_UpVectorContextCommand() override;
...
private:
	// ------ Data ------
	FlexiInstancer_UpVectorContext* m_context;
};
