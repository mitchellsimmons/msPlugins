...
FlexiChainDouble_TwistAdjustmentManip::FlexiChainDouble_TwistAdjustmentManip() : MPxManipulatorNode(),
	m_locator{ nullptr },
	m_physicalIndex{ 0 },
...
FlexiChainDouble_TwistAdjustmentManip::~FlexiChainDouble_TwistAdjustmentManip()
{
	m_locator = nullptr;
}

// Static
unsigned int FlexiChainDouble_TwistAdjustmentManip::physicalIndex = 0;
const MDistance FlexiChainDouble_TwistAdjustmentManip::m_offsetHandleRadius{ 1.2, MDistance::kCentimeters };
const double FlexiChainDouble_TwistAdjustmentManip::m_offsetHandleDragIncrement = 0.001;

// ------ MPxNode------

void FlexiChainDouble_TwistAdjustmentManip::postConstructor()
{
...
MStatus FlexiChainDouble_TwistAdjustmentManip::initialize()
{
	// No-op
	return MS::kSuccess;
}
...
MStatus FlexiChainDouble_TwistAdjustmentManip::connectToDependNode(const MObject& node)
{
	MStatus status;
...
void FlexiChainDouble_TwistAdjustmentManip::preDrawUI(const M3dView& view)
{
...
void FlexiChainDouble_TwistAdjustmentManip::drawUI(MHWRender::MUIDrawManager& drawManager, const MHWRender::MFrameContext& frameContext) const
{
...
MStatus FlexiChainDouble_TwistAdjustmentManip::doPress(M3dView& view)
{
	if (glActiveName(m_activeName))
	{
		if (m_activeName == m_handleName)
		{
			...
			MString activePlugCmd = "FlexiChainDoubleTwistAdjustmentContext -e -activeManipPlug " + getCompoundPlugPartialName();
			activePlugCmd += " FlexiChainDoubleTwistAdjustmentContext1";
			MGlobal::executeCommand(activePlugCmd);

			// Update the ramp UI if it exists and is visible (see MRS_FlexiChainDouble_twistAdjustmentUIReplace.mel for implementation)
			...
			MString updateUICmd = "MRS_FlexiChainDouble_twistAdjustmentUIReplace " + getCompoundPlugPartialName();
...
MStatus FlexiChainDouble_TwistAdjustmentManip::doDrag(M3dView& view)
{
	MStatus status;
...
MStatus FlexiChainDouble_TwistAdjustmentManip::doRelease(M3dView& view)
{
...
MStatus FlexiChainDouble_TwistAdjustmentManip::doMove(M3dView& view, bool& refresh)
{
	MPoint pCameraWorld = getCameraPosition(view);
...
MStatus FlexiChainDouble_TwistAdjustmentManip::getCompoundPlug(MPlug& compoundPlug)
{
	MStatus status;

	MPlug compoundArrayPlug{ m_locatorPath.node(), FlexiChainDouble::twistAdjustmentCompoundAttr };
...
MStatus FlexiChainDouble_TwistAdjustmentManip::getRampCompoundPlug(MPlug& rampPlug)
{
	MStatus status;
	...
	if (status)
		rampPlug = compoundPlug.child(FlexiChainDouble::twistAdjustmentRampAttr, &status);
...
MStatus FlexiChainDouble_TwistAdjustmentManip::getTwistPlug(MPlug& twistPlug)
{
	MStatus status;
	...
	status = getCompoundPlug(compoundPlug);
	if (status)
		twistPlug = compoundPlug.child(FlexiChainDouble::twistAdjustmentValueAttr, &status);
...
MStatus FlexiChainDouble_TwistAdjustmentManip::getOffsetPlug(MPlug& offsetPlug)
{
	MStatus status;
	...
	status = getCompoundPlug(compoundPlug);
	if (status)
		offsetPlug = compoundPlug.child(FlexiChainDouble::twistAdjustmentOffsetAttr, &status);
...
MString FlexiChainDouble_TwistAdjustmentManip::getCompoundPlugPartialName()
{
...
bool FlexiChainDouble_TwistAdjustmentManip::isUserInteracting()
{
	return m_isUserInteracting;
}

bool FlexiChainDouble_TwistAdjustmentManip::isMouseHovered()
{
	return m_isMouseHovered;
}

bool FlexiChainDouble_TwistAdjustmentManip::isActive()
{
	return m_isActive;
}
...
MPoint FlexiChainDouble_TwistAdjustmentManip::sampleCurve(double param)
{
	MPoint pPosition;
...
MPoint FlexiChainDouble_TwistAdjustmentManip::getCameraPosition(M3dView& view) const
{
	MDagPath cameraPath;
...
// VP2 implementation
MPoint FlexiChainDouble_TwistAdjustmentManip::getCameraPosition(const MHWRender::MFrameContext& frameContext) const
{
...
// Legacy implementation
MVector FlexiChainDouble_TwistAdjustmentManip::getCameraAimDirection(M3dView& view) const
{
	MDagPath cameraPath;
	view.getCamera(cameraPath);
	cameraPath.pop();
...
// VP2 implementation
MVector FlexiChainDouble_TwistAdjustmentManip::getCameraAimDirection(const MHWRender::MFrameContext& frameContext) const
{
...
// Legacy implementation
MVector FlexiChainDouble_TwistAdjustmentManip::getCameraUpDirection(M3dView& view) const
{
	MDagPath cameraPath;
	view.getCamera(cameraPath);
	cameraPath.pop();
...
// VP2 implementation
MVector FlexiChainDouble_TwistAdjustmentManip::getCameraUpDirection(const MHWRender::MFrameContext& frameContext) const
{
...
bool FlexiChainDouble_TwistAdjustmentManip::computeMouseIntersection(const MPoint& pMouse, const MVector& vMouseDirection, const MPoint& pPointOnInterPlane,
...
/*	Description
	...
	Returns true if the raycast produces a successful intersection    */
bool FlexiChainDouble_TwistAdjustmentManip::computeCurrentMouseIntersection(const MPoint& pPointOnInterPlane, const MVector& vInterPlaneNormal, MPoint& pIntersection)
{
...
void FlexiChainDouble_TwistAdjustmentManip::updateOffsetHandle()
{
...
MStatus FlexiChainDouble_TwistAdjustmentManip::updateOffsetHandlePlug(double offset)
{
	MStatus status;
...
FlexiChainDouble_TwistAdjustmentManipContainer::FlexiChainDouble_TwistAdjustmentManipContainer() : MPxManipContainer(),
	m_manip{ nullptr },
	m_locator{ nullptr }
{}

FlexiChainDouble_TwistAdjustmentManipContainer::~FlexiChainDouble_TwistAdjustmentManipContainer()
{
	m_manip = nullptr;
	m_locator = nullptr;
}
...
MStatus FlexiChainDouble_TwistAdjustmentManipContainer::initialize()
{
	return MPxManipContainer::initialize();
}

MStatus FlexiChainDouble_TwistAdjustmentManipContainer::createChildren()
{
	MStatus status;
	
	MPxManipulatorNode *proxyManip = 0;
	MString manipTypeName(FlexiChainDouble_TwistAdjustmentManip::kTypeName);
	MString manipName("FlexiChainDoubleTwistAdjustmentManipInst");
	status = addMPxManipulatorNode(manipTypeName, manipName, proxyManip);

	if (status)
		m_manip = (FlexiChainDouble_TwistAdjustmentManip*)proxyManip;

	return status;
}

MStatus FlexiChainDouble_TwistAdjustmentManipContainer::connectToDependNode(const MObject& node)
{
	MStatus status;
...
FlexiChainDouble_TwistAdjustmentContext::FlexiChainDouble_TwistAdjustmentContext() : MPxSelectionContext(),
	m_numActiveNodes{ 0 },
	m_selectionChangedCallbackId{ 0 }
{
	MString titleStr("FlexiChainDouble Twist Adjustment Tool");
	setTitleString(titleStr);
}

FlexiChainDouble_TwistAdjustmentContext::~FlexiChainDouble_TwistAdjustmentContext() {}
...
void FlexiChainDouble_TwistAdjustmentContext::toolOnSetup(MEvent& event)
{
	MStatus status;
	...
	if (!status)
		std::cerr << "FlexiChainDouble_TwistAdjustmentContext: MEventMessage::addEventCallback() failed" << std::endl;
...
void FlexiChainDouble_TwistAdjustmentContext::toolOffCleanup()
{
	MStatus status;
	...
	if (!status)
		cerr << "FlexiChainDouble_TwistAdjustmentContext: MNodeMessage::removeCallback() failed" << std::endl;
	m_selectionChangedCallbackId = 0;
...
MStatus FlexiChainDouble_TwistAdjustmentContext::doEnterRegion(MEvent& event)
{
	MString helpStr("Drag manipulators to define the offset for each twist adjustment falloff. Right click for more options.");
...
MStatus FlexiChainDouble_TwistAdjustmentContext::drawFeedback(MHWRender::MUIDrawManager& drawManager, const MHWRender::MFrameContext& frameContext)
{
	...
	if (m_numActiveNodes == 1)
		text = ("FlexiChainDouble  :  Twist Adjustment Tool  :  " + activeItems) + " Active Node";
	else
		text = ("FlexiChainDouble  :  Twist Adjustment Tool  :  " + activeItems) + " Active Nodes";
...
MString FlexiChainDouble_TwistAdjustmentContext::getHoverManipPlug()
{
	for (FlexiChainDouble_TwistAdjustmentManipContainer*& manipContainer : m_manipContainers)
	{
...
MString FlexiChainDouble_TwistAdjustmentContext::getActiveManipPlug()
{
	for (FlexiChainDouble_TwistAdjustmentManipContainer*& manipContainer : m_manipContainers)
	{
...
void FlexiChainDouble_TwistAdjustmentContext::setActiveManipPlug(MString& activeManipPlugName)
{
	MStatus status;
...
void FlexiChainDouble_TwistAdjustmentContext::updateManipulatorsCallback(void* data)
{
	MStatus status;

	FlexiChainDouble_TwistAdjustmentContext* context = (FlexiChainDouble_TwistAdjustmentContext*)data;
	...
	while (!iter.isDone())
	{
		...
		if (!seen && fnDep.typeId() == FlexiChainDouble::kTypeId)
		{
			...
			{
				FlexiChainDouble_TwistAdjustmentManip::physicalIndex = i;
				MString manipName(FlexiChainDouble_TwistAdjustmentManipContainer::kTypeName);
				MObject manipObject = MObject::kNullObj;
				FlexiChainDouble_TwistAdjustmentManipContainer* manipContainer = (FlexiChainDouble_TwistAdjustmentManipContainer*)FlexiChainDouble_TwistAdjustmentManipContainer::newManipulator(manipName, manipObject);
			...
			if (status)
				...
				std::cerr << "FlexiChainDouble_TwistAdjustmentContext: MNodeMessage::addAttributeChangedCallback() failed" << std::endl;
		}
...
void FlexiChainDouble_TwistAdjustmentContext::nodePlugChangedCallback(MNodeMessage::AttributeMessage msg, MPlug& plug, MPlug& otherPlug, void* data)
{
	...
	if (msg & MNodeMessage::AttributeMessage::kAttributeEval)
	{
			...
			plug == FlexiChainDouble::outputWorldPositionsAttr || plug == FlexiChainDouble::outputWorldOrientationsAttr)
		{
			...
			FlexiChainDouble_TwistAdjustmentContext* context = (FlexiChainDouble_TwistAdjustmentContext*)data;
			for (FlexiChainDouble_TwistAdjustmentManipContainer*& manipContainer : context->m_manipContainers)
			{
...
/*	Description
	-----------
	The FlexiChainDoubleTwistAdjustmentContext command is used to generate a custom context which can then be used to modify twist adjustments
	- A manipulator is created for each twistAdjustment element plug, on each selected FlexiChainDouble node assigned to the active context
	- This command allows the user to query certain states relating to those manipulators

	MEL Command
	-----------
	FlexiChainDoubleTwistAdjustmentContext [-hoverManipPlug bool] [-activeManipPlug bool] [context]
	...
	----
	context
		This is the name given to the FlexiChainDoubleTwistAdjustmentContext instance upon creation
		When querying the active context, this name must be passed to the command
*/

FlexiChainDouble_TwistAdjustmentContextCommand::FlexiChainDouble_TwistAdjustmentContextCommand() : MPxContextCommand(),
	m_context{ nullptr }
{}

FlexiChainDouble_TwistAdjustmentContextCommand::~FlexiChainDouble_TwistAdjustmentContextCommand()
{
	m_context = nullptr;
}
...
const char* FlexiChainDouble_TwistAdjustmentContextCommand::kHoverFlag = "-hmp";
const char* FlexiChainDouble_TwistAdjustmentContextCommand::kHoverFlagLong = "-hoverManipPlug";
const char* FlexiChainDouble_TwistAdjustmentContextCommand::kActiveFlag = "-amp";
const char* FlexiChainDouble_TwistAdjustmentContextCommand::kActiveFlagLong = "-activeManipPlug";

MPxContext* FlexiChainDouble_TwistAdjustmentContextCommand::makeObj()
{
	m_context = new FlexiChainDouble_TwistAdjustmentContext;
	return m_context;
}

MStatus FlexiChainDouble_TwistAdjustmentContextCommand::doEditFlags()
{
	MStatus status;
...
MStatus FlexiChainDouble_TwistAdjustmentContextCommand::doQueryFlags()
{
	MStatus status;
	MArgParser argParser = parser();
...
MStatus FlexiChainDouble_TwistAdjustmentContextCommand::appendSyntax()
{
	MStatus status;
