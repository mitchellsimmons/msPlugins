...
class FlexiChainTriple_TwistAdjustmentManip : public MPxManipulatorNode
{
public:
	FlexiChainTriple_TwistAdjustmentManip();
	~FlexiChainTriple_TwistAdjustmentManip() override;
...
private:
	friend class FlexiChainTriple_TwistAdjustmentContext;

	// ------ Data ------
	FlexiChainTriple* m_locator;
...
class FlexiChainTriple_TwistAdjustmentManipContainer : public MPxManipContainer
{
public:
	FlexiChainTriple_TwistAdjustmentManipContainer();
	~FlexiChainTriple_TwistAdjustmentManipContainer() override;
...
private:
	...
	// ------ Data ------
	FlexiChainTriple_TwistAdjustmentManip* m_manip;
	FlexiChainTriple* m_locator;
	MDagPath m_locatorPath;
};
...
class FlexiChainTriple_TwistAdjustmentContext : public MPxSelectionContext
{
public:
	FlexiChainTriple_TwistAdjustmentContext();
	~FlexiChainTriple_TwistAdjustmentContext() override;
...
private:
	...
	std::vector<FlexiChainTriple_TwistAdjustmentManipContainer*> m_manipContainers;
};

// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------

// Class defines a command that will be used to create a single instance of the above context
class FlexiChainTriple_TwistAdjustmentContextCommand : public MPxContextCommand
{
public:
	FlexiChainTriple_TwistAdjustmentContextCommand();
	~FlexiChainTriple_TwistAdjustmentContextCommand() override;
...
private:
	// ------ Data ------
	FlexiChainTriple_TwistAdjustmentContext* m_context;
};
