...
class FlexiSpine_UpVectorManip : public MPxManipulatorNode
{
public:
	FlexiSpine_UpVectorManip();
	~FlexiSpine_UpVectorManip() override;
...
private:
	friend class FlexiSpine_UpVectorContext;
...
class FlexiSpine_UpVectorManipContainer : public MPxManipContainer
{
public:
	FlexiSpine_UpVectorManipContainer();
	~FlexiSpine_UpVectorManipContainer() override;
...
private:
	...
	// ------ Data ------
	FlexiSpine_UpVectorManip* m_manip;
	FlexiSpine* m_locator;
	MDagPath m_locatorPath;
};
...
class FlexiSpine_UpVectorContext : public MPxSelectionContext
{
public:
	FlexiSpine_UpVectorContext();
	~FlexiSpine_UpVectorContext() override;
...
private:
	...
	std::vector<FlexiSpine_UpVectorManipContainer*> m_manipContainers;
};

// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------

// Class defines a command that will be used to create a single instance of the above context
class FlexiSpine_UpVectorContextCommand : public MPxContextCommand
{
public:
	FlexiSpine_UpVectorContextCommand();
	~FlexiSpine_UpVectorContextCommand() override;
...
private:
	// ------ Data ------
	FlexiSpine_UpVectorContext* m_context;
};
