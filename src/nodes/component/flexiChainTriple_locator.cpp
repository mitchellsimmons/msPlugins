...
/*	Description
	-----------
	This node approximates and draws three continuous cubic trigonemtric Bezier curves, each with two shaping parameters
	...
	Attributes
	----------
	controlPoint0, controlPoint1, controlPoint2, controlPoint3, controlPoint4 - vector
		Specifies the five local space positions which determine the hull of the T-Bezier and help define its shape
	...
	parameterization - enum
		...
		Split Arc Length	(2)		The curve will be split into four segments at the three joints
	...
	jointOffset0, jointOffset1, jointOffset2 - double
	...
	jointRadius0, jointRadius1, jointRadius2 - distance
	...
	jointVolume0, jointVolume1, jointVolume2 -double [-1.0, 1.0]
...
FlexiChainTriple::FlexiChainTriple() :
...
FlexiChainTriple::FlexiChainTriple_Data::FlexiChainTriple_Data() :
	outputCount{ 0 },
	parameterCount{ 0 },
	sampleCount{ 0 },
	subdivisions{ 0 },
...
// ------ Constants ------
const unsigned int FlexiChainTriple::FlexiChainTriple_Data::order = 3;
const unsigned int FlexiChainTriple::FlexiChainTriple_Data::degree = 3;
const double FlexiChainTriple::FlexiChainTriple_Data::parameterRange = 3.0;

// ------ Attr ------
MObject FlexiChainTriple::controlPoint0Attr;
MObject FlexiChainTriple::controlPoint0XAttr;
MObject FlexiChainTriple::controlPoint0YAttr;
MObject FlexiChainTriple::controlPoint0ZAttr;
MObject FlexiChainTriple::controlPoint1Attr;
MObject FlexiChainTriple::controlPoint1XAttr;
MObject FlexiChainTriple::controlPoint1YAttr;
MObject FlexiChainTriple::controlPoint1ZAttr;
MObject FlexiChainTriple::controlPoint2Attr;
MObject FlexiChainTriple::controlPoint2XAttr;
MObject FlexiChainTriple::controlPoint2YAttr;
MObject FlexiChainTriple::controlPoint2ZAttr;
MObject FlexiChainTriple::controlPoint3Attr;
MObject FlexiChainTriple::controlPoint3XAttr;
MObject FlexiChainTriple::controlPoint3YAttr;
MObject FlexiChainTriple::controlPoint3ZAttr;
MObject FlexiChainTriple::controlPoint4Attr;
MObject FlexiChainTriple::controlPoint4XAttr;
MObject FlexiChainTriple::controlPoint4YAttr;
MObject FlexiChainTriple::controlPoint4ZAttr;
MObject FlexiChainTriple::jointOffset0Attr;
MObject FlexiChainTriple::jointRadius0Attr;
MObject FlexiChainTriple::jointVolume0Attr;
MObject FlexiChainTriple::jointOffset1Attr;
MObject FlexiChainTriple::jointRadius1Attr;
MObject FlexiChainTriple::jointVolume1Attr;
MObject FlexiChainTriple::jointOffset2Attr;
MObject FlexiChainTriple::jointRadius2Attr;
MObject FlexiChainTriple::jointVolume2Attr;
MObject FlexiChainTriple::upVectorAttr;
MObject FlexiChainTriple::upVectorXAttr;
MObject FlexiChainTriple::upVectorYAttr;
MObject FlexiChainTriple::upVectorZAttr;
MObject FlexiChainTriple::rotateOrderAttr;
MObject FlexiChainTriple::computeOrientationAttr;
MObject FlexiChainTriple::subdivisionsAttr;
MObject FlexiChainTriple::outputCountAttr;
MObject FlexiChainTriple::parameterizationAttr;
MObject FlexiChainTriple::normalUpVectorOverrideCompoundAttr;
MObject FlexiChainTriple::normalUpVectorOverrideStateAttr;
MObject FlexiChainTriple::normalUpVectorOverrideAttr;
MObject FlexiChainTriple::normalUpVectorOverrideXAttr;
MObject FlexiChainTriple::normalUpVectorOverrideYAttr;
MObject FlexiChainTriple::normalUpVectorOverrideZAttr;
MObject FlexiChainTriple::counterTwistUpVectorOverrideCompoundAttr;
MObject FlexiChainTriple::counterTwistUpVectorOverrideStateAttr;
MObject FlexiChainTriple::counterTwistUpVectorOverrideAttr;
MObject FlexiChainTriple::counterTwistUpVectorOverrideXAttr;
MObject FlexiChainTriple::counterTwistUpVectorOverrideYAttr;
MObject FlexiChainTriple::counterTwistUpVectorOverrideZAttr;
MObject FlexiChainTriple::counterTwistBlendAttr;
MObject FlexiChainTriple::counterTwistAttr;
MObject FlexiChainTriple::startTwistAttr;
MObject FlexiChainTriple::endTwistAttr;
MObject FlexiChainTriple::rollAttr;
MObject FlexiChainTriple::drawRibbonAttr;
MObject FlexiChainTriple::drawCurveAttr;
MObject FlexiChainTriple::drawNormalsAttr;
MObject FlexiChainTriple::drawHullAttr;
MObject FlexiChainTriple::drawSpaceTransformationAttr;
MObject FlexiChainTriple::customDrawSpaceTransformAttr;
MObject FlexiChainTriple::computeTwistAdjustmentsAttr;
MObject FlexiChainTriple::twistAdjustmentCompoundAttr;
MObject FlexiChainTriple::twistAdjustmentRampAttr;
MObject FlexiChainTriple::twistAdjustmentRampPositionAttr;
MObject FlexiChainTriple::twistAdjustmentRampValueAttr;
MObject FlexiChainTriple::twistAdjustmentRampInterpolationAttr;
MObject FlexiChainTriple::twistAdjustmentValueAttr;
MObject FlexiChainTriple::twistAdjustmentOffsetAttr;
MObject FlexiChainTriple::twistAdjustmentFalloffModeAttr;
MObject FlexiChainTriple::twistAdjustmentFalloffDistanceAttr;
MObject FlexiChainTriple::twistAdjustmentRepeatAttr;
MObject FlexiChainTriple::computeScaleAdjustmentsAttr;
MObject FlexiChainTriple::scaleAdjustmentCompoundAttr;
MObject FlexiChainTriple::scaleAdjustmentRampAttr;
MObject FlexiChainTriple::scaleAdjustmentRampPositionAttr;
MObject FlexiChainTriple::scaleAdjustmentRampValueAttr;
MObject FlexiChainTriple::scaleAdjustmentRampInterpolationAttr;
MObject FlexiChainTriple::scaleAdjustmentValueAttr;
MObject FlexiChainTriple::scaleAdjustmentValueXAttr;
MObject FlexiChainTriple::scaleAdjustmentValueYAttr;
MObject FlexiChainTriple::scaleAdjustmentValueZAttr;
MObject FlexiChainTriple::scaleAdjustmentOffsetAttr;
MObject FlexiChainTriple::scaleAdjustmentFalloffModeAttr;
MObject FlexiChainTriple::scaleAdjustmentFalloffDistanceAttr;
MObject FlexiChainTriple::scaleAdjustmentRepeatAttr;
MObject FlexiChainTriple::evalSinceDirtyAttr;
MObject FlexiChainTriple::drawSinceEvalAttr;
MObject FlexiChainTriple::outputLocalFramesAttr;
MObject FlexiChainTriple::outputLocalPositionsAttr;
MObject FlexiChainTriple::outputLocalOrientationsAttr;
MObject FlexiChainTriple::outputLocalScalesAttr;
MObject FlexiChainTriple::outputWorldFramesAttr;
MObject FlexiChainTriple::outputWorldPositionsAttr;
MObject FlexiChainTriple::outputWorldOrientationsAttr;
MObject FlexiChainTriple::outputWorldScalesAttr;

// ------ MPxNode ------
MPxNode::SchedulingType FlexiChainTriple::schedulingType() const
{
	return SchedulingType::kParallel;
}

void FlexiChainTriple::postConstructor()
{
...
MStatus FlexiChainTriple::initialize()
{
	...
	createVectorAttribute(controlPoint3Attr, controlPoint3XAttr, controlPoint3YAttr, controlPoint3ZAttr, "controlPoint3", "controlPoint3",
		controlPoint, kDefaultPreset | kKeyable);
	createVectorAttribute(controlPoint4Attr, controlPoint4XAttr, controlPoint4YAttr, controlPoint4ZAttr, "controlPoint4", "controlPoint4",
		controlPoint, kDefaultPreset | kKeyable);
	...
	createDoubleAttribute(jointOffset2Attr, "jointOffset2", "jointOffset2", 0.0, kDefaultPreset | kKeyable);
	createDistanceAttribute(jointRadius2Attr, "jointRadius2", "jointRadius2", 10.0, kDefaultPreset | kKeyable);
	createDoubleAttribute(jointVolume2Attr, "jointVolume2", "jointVolume2", 0.0, kDefaultPreset | kKeyable);
	setMinMax<double>(jointVolume2Attr, -1.0, 1.0);
	...
	addAttribute(controlPoint4Attr);
	...
	addAttribute(jointOffset2Attr);
	addAttribute(jointRadius2Attr);
	addAttribute(jointVolume2Attr);
	...
	attributeAffects(controlPoint4Attr, outputLocalFramesAttr);
	...
	attributeAffects(jointOffset2Attr, outputLocalFramesAttr);
	attributeAffects(jointRadius2Attr, outputLocalFramesAttr);
	attributeAffects(jointVolume2Attr, outputLocalFramesAttr);
	...
	attributeAffects(controlPoint4Attr, outputLocalPositionsAttr);
	...
	attributeAffects(jointOffset2Attr, outputLocalPositionsAttr);
	attributeAffects(jointRadius2Attr, outputLocalPositionsAttr);
	attributeAffects(jointVolume2Attr, outputLocalPositionsAttr);
	...
	attributeAffects(controlPoint4Attr, outputLocalOrientationsAttr);
	...
	attributeAffects(jointOffset2Attr, outputLocalOrientationsAttr);
	attributeAffects(jointRadius2Attr, outputLocalOrientationsAttr);
	attributeAffects(jointVolume2Attr, outputLocalOrientationsAttr);
	...
	attributeAffects(controlPoint4Attr, outputLocalScalesAttr);
	...
	attributeAffects(jointOffset2Attr, outputLocalScalesAttr);
	attributeAffects(jointRadius2Attr, outputLocalScalesAttr);
	attributeAffects(jointVolume2Attr, outputLocalScalesAttr);
	...
	attributeAffects(controlPoint4Attr, outputWorldFramesAttr);
	...
	attributeAffects(jointOffset2Attr, outputWorldFramesAttr);
	attributeAffects(jointRadius2Attr, outputWorldFramesAttr);
	attributeAffects(jointVolume2Attr, outputWorldFramesAttr);
	...
	attributeAffects(controlPoint4Attr, outputWorldPositionsAttr);
	...
	attributeAffects(jointOffset2Attr, outputWorldPositionsAttr);
	attributeAffects(jointRadius2Attr, outputWorldPositionsAttr);
	attributeAffects(jointVolume2Attr, outputWorldPositionsAttr);
	...
	attributeAffects(controlPoint4Attr, outputWorldOrientationsAttr);
	...
	attributeAffects(jointOffset2Attr, outputWorldOrientationsAttr);
	attributeAffects(jointRadius2Attr, outputWorldOrientationsAttr);
	attributeAffects(jointVolume2Attr, outputWorldOrientationsAttr);
	...
	attributeAffects(controlPoint4Attr, outputWorldScalesAttr);
	...
	attributeAffects(jointOffset2Attr, outputWorldScalesAttr);
	attributeAffects(jointRadius2Attr, outputWorldScalesAttr);
	attributeAffects(jointVolume2Attr, outputWorldScalesAttr);
...
MStatus FlexiChainTriple::setDependentsDirty(const MPlug& plug, MPlugArray& plugArray)
{
	...
	if (plug == controlPoint0Attr || plug == controlPoint0XAttr || plug == controlPoint0YAttr || plug == controlPoint0ZAttr ||
		...
		plug == controlPoint4Attr || plug == controlPoint4XAttr || plug == controlPoint4YAttr || plug == controlPoint4ZAttr ||
		...
		plug == jointOffset2Attr ||
		plug == jointRadius2Attr ||
		plug == jointVolume2Attr ||
...
MStatus FlexiChainTriple::preEvaluation(const MDGContext& context, const MEvaluationNode& evaluationNode)
{
	if (context.isNormal())
	{
		MStatus status;
		...
		if ((evaluationNode.dirtyPlugExists(controlPoint0Attr, &status) && status) ||
			...
			(evaluationNode.dirtyPlugExists(controlPoint4Attr, &status) && status) ||
			(evaluationNode.dirtyPlugExists(controlPoint4XAttr, &status) && status) ||
			(evaluationNode.dirtyPlugExists(controlPoint4YAttr, &status) && status) ||
			(evaluationNode.dirtyPlugExists(controlPoint4ZAttr, &status) && status) ||
			...
			(evaluationNode.dirtyPlugExists(jointOffset2Attr, &status) && status) ||
			(evaluationNode.dirtyPlugExists(jointRadius2Attr, &status) && status) ||
			(evaluationNode.dirtyPlugExists(jointVolume2Attr, &status) && status) ||
...
MStatus FlexiChainTriple::compute(const MPlug& plug, MDataBlock& dataBlock)
{
...
bool FlexiChainTriple::isBounded() const
{
	return true;
}
...
MBoundingBox FlexiChainTriple::boundingBox() const
{
	MBoundingBox bbox;
	...
	for (unsigned int i = 0; i < m_data.controlPoints2.size(); i++)
		bbox.expand(m_data.controlPoints2[i]);
...
void FlexiChainTriple::computeCurveData(MDataBlock& dataBlock)
{
	// --- Counts ---
	...
	m_data.jointVolume2 = dataBlock.inputValue(jointVolume2Attr).asDouble();
	...
	MVector P4 = dataBlock.inputValue(controlPoint4Attr).asVector();
	...
	vP1ToP3.normalize();
	MVector vP3ToP2 = P2 - P3;
	vP3ToP2.normalize();
	MVector vP3ToP4 = P4 - P3;
	vP3ToP4.normalize();
	MVector vP2ToP4 = P4 - P2;
	vP2ToP4.normalize();
	...
	// --- Joint 2 ---
	// Rotate the P3ToP2 vector by offsetAngle2 (using Rodrigues formula) to find the offset direction of the third joint
	double jointAngle2 = acos(vP3ToP2 * vP3ToP4);
	double offsetAngle2 = M_PI_2 - jointAngle2 / 2;
	double dot2 = vP3ToP2 * vP3ToP4;
	double cosOffsetAngle2 = cos(-offsetAngle2);
	double sinOffsetAngle2 = sin(-offsetAngle2);
	double cosCounterOffsetAngle2 = cos(offsetAngle2);
	double sinCounterOffsetAngle2 = sin(offsetAngle2);
	MVector vRotPlaneNormal2 = vP3ToP2 ^ vP3ToP4;
	vRotPlaneNormal2.normalize();
	MVector vCrossNormalWithP3ToP2 = vRotPlaneNormal2 ^ vP3ToP2;
	double dotNormalWithP3ToP2 = vRotPlaneNormal2 * vP3ToP2;
	MVector vRotatedP3ToP2 = vP3ToP2 * cosOffsetAngle2 + vCrossNormalWithP3ToP2 * sinOffsetAngle2 +
		vRotPlaneNormal2 * dotNormalWithP3ToP2 * (1.0 - cosOffsetAngle2);
	MVector vCounterRotatedP3ToP2 = vP3ToP2 * cosCounterOffsetAngle2 + vCrossNormalWithP3ToP2 * sinCounterOffsetAngle2 +
		vRotPlaneNormal2 * dotNormalWithP3ToP2 * (1.0 - cosCounterOffsetAngle2);

	// Find the maximum dot product delta and determine the offset directions
	MVector vLateralOffsetDirection2;
	MVector vPerpendicularOffsetDirection2;
	if (dot2 - vRotatedP3ToP2 * vP3ToP4 < dot2 - vCounterRotatedP3ToP2 * vP3ToP4)
	{
		vLateralOffsetDirection2 = vCounterRotatedP3ToP2;
		vPerpendicularOffsetDirection2 = vRotPlaneNormal2 ^ vRotatedP3ToP2;
	}
	else
	{
		vLateralOffsetDirection2 = vRotatedP3ToP2;
		vPerpendicularOffsetDirection2 = vRotatedP3ToP2 ^ vRotPlaneNormal2;
	}

	// Offset the mid point along the perpendicular vector
	double jointOffsetMultiplier2 = dataBlock.inputValue(jointOffset2Attr).asDouble();
	double theta2 = acos(vP3ToP2 * -vP2ToP4);
	double alpha2 = M_PI - (jointAngle2 / 2) - theta2;
	double jointOffset2 = ((P3 - P2).length() / sin(alpha2)) * sin(theta2) * jointOffsetMultiplier2 / 19.0;
	P3 = P3 + jointOffset2 * vPerpendicularOffsetDirection2;
	...
	double jointRadius2 = dataBlock.inputValue(jointRadius2Attr).asDouble();
	...
	MVector vVirtualP5 = P3 + vLateralOffsetDirection2 * jointRadius2;
	MVector vVirtualP6 = P3 + vLateralOffsetDirection2 * jointRadius2 * -1;
	MVector vVirtualP7 = P4;
	...
	m_data.controlPoints1[3] = vVirtualP4 + (vVirtualP5 - vVirtualP4) / 2;
	m_data.controlPoints2[0] = m_data.controlPoints1[3];
	m_data.controlPoints2[1] = vVirtualP5;
	m_data.controlPoints2[2] = vVirtualP6;
	m_data.controlPoints2[3] = vVirtualP7;
...
void FlexiChainTriple::computeScaleAdjustments(MDataBlock& dataBlock)
{
...
/*	Description
	...
	It has been separated from the compute function as the manipulators associated with this node also need to be able to trigger the update
	- When the associated array plug is altered (elements added or removed) this will not trigger a call to compute    */
void FlexiChainTriple::computeTwistAdjustments(MDataBlock& dataBlock)
{
...
void FlexiChainTriple::computeLengths()
{
	// Cache arc-lengths by uniformly incrementing over the curves natural parameter t
	// In this case the combined curve P(t) has a domain P:[0,3] as we are incrementing over three continuous curves
...
/*	Description
	...
	There is an increasing relationship between s and t over the curve's domain [0,3]
	This relationship can be expressed as L(t)=s, L:[0,3]->[0,1]
	Subsequently the relationship can be expressed as L^-1(s)=t, L^-1:[0,1]->[0,3]
...
void FlexiChainTriple::computeArcLengthParameters()
{
...
/*	Description
	...
	The calculation splits the curve into four segments determined by three points on the curve
	- One closest to the point half way between virtual control points P1 and P2, one closest to the point half way between virtual control points P3 and P4
	and one closest to the point half way between virtual control points P5 and P6
	...
	- Each segment should be responsible for calculating a quarter of the parameters    */
void FlexiChainTriple::computeSplitLengthParameters()
{
	double paramMult = 1.0 / m_data.parameterRange;

	// The curve is not well defined if there are less than five samples
	m_data.splitLengthParameters[0] = 0.0;
	if (m_data.parameterCount == 2)
	{
		m_data.splitLengthParameters[1] = 3.0;
		return;
	}
	else if (m_data.parameterCount == 3)
	{
		m_data.splitLengthParameters[1] = 1.5;
		m_data.splitLengthParameters[2] = 3.0;
		return;
	}
	else if (m_data.parameterCount == 4)
	{
		m_data.splitLengthParameters[1] = 1.0;
		m_data.splitLengthParameters[2] = 2.0;
		m_data.splitLengthParameters[3] = 3.0;
		return;
	}

	// We can approximate the three stable parameters by minimizing the distance to our target points
	...
	// We know each of the closest points will occur close to 16.66%, 50% and 83.33% of the curves natural parameter respectively so we will begin our search from here
	...
	unsigned int closestIndex0 = m_data.parameterCount / 6;
	...
	// We can calculate, tStable0 = closestIndex0 / ((parameterCount - 1) * 0.5)
	...
	unsigned int closestIndex1 = m_data.parameterCount / 2;
	...
	// --- Closest Point Joint2 ---
	targetPoint = m_data.controlPoints2[1] + (m_data.controlPoints2[2] - m_data.controlPoints2[1]) / 2;
	// This will always be larger than 0 but may be equal to parameterCount-1
	unsigned int closestIndex2 = (m_data.parameterCount * 5) / 6;
	vDisplacement = targetPoint - m_data.naturalPoints[closestIndex2];
	closestMag = vDisplacement.length();
	vDisplacement = targetPoint - m_data.naturalPoints[closestIndex2 - 1];
	earlyMag = vDisplacement.length();

	if (closestIndex2 == m_data.parameterCount - 1)
		lateMag = closestMag;
	else
	{
		vDisplacement = targetPoint - m_data.naturalPoints[closestIndex2 + 1];
	...
	if (direction != 0)
	{
		...
		while (nextMag < closestMag)
		{
			closestIndex2 += direction;
			closestMag = nextMag;

			// Check bounds
			if (closestIndex2 == 0 && direction == -1)
				break;
			if (closestIndex2 == m_data.parameterCount - 1 && direction == 1)
				break;

			vDisplacement = targetPoint - m_data.naturalPoints[closestIndex2 + direction];
			nextMag = vDisplacement.length();
		}
	}

	// Same as before, determine the skew
	double tStable2 = closestIndex2 / ((m_data.parameterCount - 1) * paramMult);

	vDisplacement = targetPoint - m_data.naturalPoints[closestIndex2]; vDisplacement.normalize();
	vTangent = sampleFirstDerivative(closestIndex2 / ((m_data.parameterCount - 1) * paramMult));
	closestProduct = vDisplacement * vTangent;
	...
	{
		vDisplacement = targetPoint - m_data.naturalPoints[closestIndex2 - 1]; vDisplacement.normalize();
		vTangent = sampleFirstDerivative((closestIndex2 - 1) / ((m_data.parameterCount - 1) * paramMult));
		earlyProduct = vDisplacement * vTangent;
	}
	...
	bool isMinimumEarly2 = (earlyProduct < 0 && closestProduct > 0) || (earlyProduct > 0 && closestProduct < 0);
	bool isMinimumLate2 = (lateProduct < 0 && closestProduct > 0) || (lateProduct > 0 && closestProduct < 0);

	if (isMinimumEarly2)
	{
		// The minimum occurs before tStable2
		double productDelta = std::abs(earlyProduct) + std::abs(closestProduct);
		double minimumRatio = std::abs(closestProduct) / productDelta;
		double step = m_data.parameterRange / (m_data.parameterCount - 1);
		tStable2 = tStable2 - step * minimumRatio;
	}
	else if (isMinimumLate2)
	{
		// The minimum occurs after tStable2
		double productDelta = std::abs(lateProduct) + std::abs(closestProduct);
		double minimumRatio = std::abs(closestProduct) / productDelta;
		double step = m_data.parameterRange / (m_data.parameterCount - 1);
		tStable2 = tStable2 + step * minimumRatio;
	...
	// --- Edge Case ---
	// When two joints overlap each other, the entire segment of the curve between those joints becomes a minimum
	// If this occurs we will ensure all of the samples for that segment are condensed to this single point
	if (tStable1 > tStable2)
	{
		tStable1 = tStable2;
		closestIndex1 = closestIndex2;
		isMinimumEarly1 = isMinimumEarly2;
		isMinimumLate1 = isMinimumLate2;
	}
	...
	// In the case where the parameterCount is not evenly divisible by the 4 segments, the first segments will have preference and receive the extra samples
	// There are five constant points (start, stable0, stable1, stable2, end), from this we can determine the distribution:
	unsigned int remainingCount = m_data.parameterCount - 5;
	unsigned int segment0SampleCount = (unsigned)std::ceil(remainingCount / 4.0);
	remainingCount -= segment0SampleCount;
	unsigned int segment1SampleCount = (unsigned)std::ceil(remainingCount / 3.0);
	remainingCount -= segment1SampleCount;
	unsigned int segment2SampleCount = (unsigned)std::ceil(remainingCount / 2.0);
	remainingCount -= segment2SampleCount;
	unsigned int segment3SampleCount = remainingCount;
	...
	unsigned int stable2Index = segment0SampleCount + segment1SampleCount + segment2SampleCount + 3; // +3 for start, stable0 and stable1 points
	...
	// --- Segment2 ---
	// Using the total arc-length of segment1, iterate over uniform increments and approximate values of t for (tStable1, tStable2)
	double segment2ArcLength = m_curve.naturalToArcLengthParameter(tStable2 * paramMult, m_data.lengths) * 
		m_data.lengths[m_data.parameterCount - 1] - segment0ArcLength - segment1ArcLength;
	double segment2Step = 1.0 / (segment2SampleCount + 1);
	double segment2Percent = 0.0;

	for (unsigned int i = stable1Index + 1; i < stable2Index; ++i)
	{
		...
		unsigned int high = isMinimumLate2 ? closestIndex2 + 1 : closestIndex2;
		unsigned int index;
		double tLength;
	...
	m_data.splitLengthParameters[stable2Index] = tStable2;

	// --- Segment3 ---
	// Using the total arc-length of segment3, iterate over uniform increments and approximate values of t for (tStable2, 2.0)
	double segment3ArcLength = m_data.lengths[m_data.parameterCount - 1] - segment0ArcLength - segment1ArcLength - segment2ArcLength;
	double segment3Step = 1.0 / (segment3SampleCount + 1);
	double segment3Percent = 0.0;

	for (unsigned int i = stable2Index + 1; i < m_data.parameterCount - 1; ++i)
	{
		segment3Percent += segment3Step;
		double targetLength = segment0ArcLength + segment1ArcLength + segment2ArcLength + segment3Percent * segment3ArcLength;

		unsigned int low = isMinimumEarly2 ? closestIndex2 - 1 : closestIndex2;
		unsigned int high = m_data.parameterCount;
		unsigned int index;
		double tLength;
	...
	m_data.splitLengthParameters[m_data.parameterCount - 1] = 3.0;
}
...
/*	Description
	...
	Args
	----
	splitLengthParameter = The split-length parameter from which to calculate the equivalent natural parameter, range = [0.0, 3.0]    */
double FlexiChainTriple::splitLengthToNaturalParameter(double splitLengthParameter)
{
	if (splitLengthParameter == 0.0 || splitLengthParameter == 3.0)
	...
	// --- Find Parameter ---
	double segment0ArcLength = m_curve.naturalToArcLengthParameter(tStable0 * paramMult , m_data.lengths) * m_data.lengths[m_data.parameterCount - 1];
	double segment1ArcLength = m_curve.naturalToArcLengthParameter(tStable1 * paramMult, m_data.lengths) * m_data.lengths[m_data.parameterCount - 1] - 
		segment0ArcLength;
	double segment2ArcLength = m_curve.naturalToArcLengthParameter(tStable2 * paramMult, m_data.lengths) * m_data.lengths[m_data.parameterCount - 1] - 
		segment0ArcLength - segment1ArcLength;
	double segment3ArcLength = m_data.lengths[m_data.parameterCount - 1] - segment0ArcLength - segment1ArcLength - segment2ArcLength;
	double segmentParamSize = m_data.parameterRange / 4.0;
	...
	else if (splitLengthParameter >= 2 * segmentParamSize && splitLengthParameter < 3 * segmentParamSize)
	{
	...
	{
		double segmentRatio = (splitLengthParameter - 3 * segmentParamSize) / segmentParamSize;
		targetLength = segment0ArcLength + segment1ArcLength + segment2ArcLength + segment3ArcLength * segmentRatio;
	}
...
MStatus FlexiChainTriple::computeNormalStability(double& outStability)
{
	if (!m_data.isOrientEnabled)
...
/*	Description
	...
	This function will return success if orient data is being computed, failure otherwise    */
MStatus FlexiChainTriple::computeCounterTwistStability(double& outStability)
{
	if (!m_data.isOrientEnabled)
		return MStatus::kFailure;

	MVector vUpperBoundTangent = m_data.controlPoints2[3] - m_data.controlPoints2[2];
...
/*	Description
	-----------
	This function is called exclusively by the FlexiChainTripleCounterTwist command and is used to calculate the counter twist cache for this node
...
MStatus FlexiChainTriple::computeCounterTwist(MTime startTime, MTime endTime, MTime timeStep, MObject& animCurveObj, MAnimCurveChange& animMod)
{
	MStatus status;
...
/*	Description
	...
	Args
	----
	t = Natural parameter of curve, range = [0,3]    */
MVector FlexiChainTriple::sampleCurve(double t) const
{
	...
	if (t <= 1.0)
		...
		vCurveSample = m_curve.sampleCurve(t - 2.0, m_data.jointVolume2, m_data.jointVolume2, m_data.controlPoints2);
...
/*	Description
	...
	----
	t = Natural parameter of curve, range = [0,3]    */
MVector FlexiChainTriple::sampleFirstDerivative(double t) const
{
	MVector vTangent;
	...
	if (t <= 1.0)
		...
		vTangent = m_curve.sampleFirstDerivative(t - 2.0, m_data.jointVolume2, m_data.jointVolume2, m_data.controlPoints2);

	return vTangent;
}

void FlexiChainTriple::instancingChangedCallback(MDagPath& child, MDagPath& parent, void* clientData)
{
	MGlobal::displayWarning("FlexiChainTripleShape does not support instancing!");
}

const MRS::CubicTBezier& FlexiChainTriple::getCurve() const { return m_curve; }
const FlexiChainTriple::FlexiChainTriple_Data& FlexiChainTriple::getCurveData() const { return m_data; }
MDataBlock FlexiChainTriple::getDataBlock() { return forceCache(); }

// ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------

/*	Description
	-----------
	The FlexiChainTripleCounterTwist command is used to calculate the counter twist cache for a given FlexiChainTriple node
	Counter twist is an iterative calculation which is designed to stabalise the end frame of the curve
	It essentially mitigates any twist deviation induced on the moving frame of the curve over a specified time range

	MEL Command
	-----------
	FlexiChainTripleCounterTwist [-startTime float] [-endTime float] [-timeStep float] [object]
...
FlexiChainTriple_CounterTwistCommand::FlexiChainTriple_CounterTwistCommand() : MPxCommand() {}
FlexiChainTriple_CounterTwistCommand::~FlexiChainTriple_CounterTwistCommand() {}

// ------ Registration ------

const char* FlexiChainTriple_CounterTwistCommand::kStartTimeFlag = "-st";
const char* FlexiChainTriple_CounterTwistCommand::kStartTimeFlagLong = "-startTime";
const char* FlexiChainTriple_CounterTwistCommand::kEndTimeFlag = "-et";
const char* FlexiChainTriple_CounterTwistCommand::kEndTimeFlagLong = "-endTime";
const char* FlexiChainTriple_CounterTwistCommand::kTimeStepFlag = "-ts";
const char* FlexiChainTriple_CounterTwistCommand::kTimeStepFlagLong = "-timeStep";

MSyntax FlexiChainTriple_CounterTwistCommand::newSyntax()
{
	MSyntax syntax;
...
#define kErrorNoValidObject \
	"This command requires a single FlexiChainTriple or its transform node to be specified or selected."

#define kErrorInvalidType \
	"Object \"^1s\" has an invalid type. Only a FlexiChainTriple or its transform can be specified."
...
bool FlexiChainTriple_CounterTwistCommand::isUndoable() const
{
	return true;
}

MStatus FlexiChainTriple_CounterTwistCommand::doIt(const MArgList& args)
{
	MStatus status;
	...
	// Check if the selected plugin shape is a FlexiChainTriple node
	MDagPath pluginPath;
	iter.getDagPath(pluginPath);
	MFnDependencyNode fnDep{ pluginPath.node() };
	if (fnDep.typeId() != FlexiChainTriple::kTypeId)
	{
		MString msg;
		MString msgFormat = kErrorInvalidType;
		msg.format(msgFormat, path.partialPathName());
	...
	MPlug orientEnabledPlug{ pluginPath.node(), FlexiChainTriple::computeOrientationAttr };
	...
	MPlug counterTwistPlug{ pluginPath.node(), FlexiChainTriple::counterTwistAttr };
...
MStatus FlexiChainTriple_CounterTwistCommand::redoIt()
{
	MStatus status;
...
MStatus FlexiChainTriple_CounterTwistCommand::undoIt()
{
	MStatus status;
...
/*	Description
	-----------
	The FlexiChainTripleStability command is used to query the stability of the computed orient data
	...
	MEL Command
	-----------
	FlexiChainTripleStability [-time float] [-normal] [-counterTwist] [object]
...
FlexiChainTriple_StabilityCommand::FlexiChainTriple_StabilityCommand() {}
FlexiChainTriple_StabilityCommand::~FlexiChainTriple_StabilityCommand() {}

// ------ Registration ------

const char* FlexiChainTriple_StabilityCommand::kTimeFlag = "-t";
const char* FlexiChainTriple_StabilityCommand::kTimeFlagLong = "-time";
const char* FlexiChainTriple_StabilityCommand::kNormalFlag = "-n";
const char* FlexiChainTriple_StabilityCommand::kNormalFlagLong = "-normal";
const char* FlexiChainTriple_StabilityCommand::kCounterTwistFlag = "-ct";
const char* FlexiChainTriple_StabilityCommand::kCounterTwistFlagLong = "-counterTwist";

MSyntax FlexiChainTriple_StabilityCommand::newSyntax()
{
	MSyntax syntax;
...
MStatus FlexiChainTriple_StabilityCommand::doIt(const MArgList& args)
{
	MStatus status;
	...
	// Check orient is enabled for the node
	bool isOrientEnabled = dataBlock.inputValue(FlexiChainTriple::computeOrientationAttr).asBool();
	if (!isOrientEnabled)
	{
		MString msg;
		MString msgFormat = kErrorOrientationDisabled;
	...
	// We must force a DG update (we can either call the "refresh" command or manually pull data from an output)
	dataBlock.inputValue(FlexiChainTriple::outputWorldFramesAttr);
