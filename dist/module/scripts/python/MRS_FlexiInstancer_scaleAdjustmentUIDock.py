...
_scaleAdjustmentDockName = "MRS_FlexiInstancer_ScaleAdjustmentUI_WorkspaceControl"
_scaleAdjustmentWindowName = "MRS_FlexiInstancer_ScaleAjustmentUI"
...
def scaleAdjustmentDockUI():
    ...
    if _scaleAdjustmentDockWidget is None:
        ...
        if not cmds.workspaceControl(_scaleAdjustmentDockName, q = True, exists = True):
            ...
            uiScript = "import MRS_FlexiInstancer_scaleAdjustmentUIDock\nMRS_FlexiInstancer_scaleAdjustmentUIDock.scaleAdjustmentDockUIScript()"
