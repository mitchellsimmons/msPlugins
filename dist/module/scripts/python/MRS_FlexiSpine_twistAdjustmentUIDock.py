...
_twistAdjustmentDockName = "MRS_FlexiSpine_TwistAdjustmentUI_WorkspaceControl"
_twistAdjustmentWindowName = "MRS_FlexiSpine_TwistAjustmentUI"
...
def twistAdjustmentDockUI():
    ...
    if _twistAdjustmentDockWidget is None:
        ...
        if not cmds.workspaceControl(_twistAdjustmentDockName, q = True, exists = True):
            ...
            uiScript = "import MRS_FlexiSpine_twistAdjustmentUIDock\nMRS_FlexiSpine_twistAdjustmentUIDock.twistAdjustmentDockUIScript()"
