...
_twistAdjustmentDockName = "MRS_FlexiInstancer_TwistAdjustmentUI_WorkspaceControl"
_twistAdjustmentWindowName = "MRS_FlexiInstancer_TwistAjustmentUI"
...
def twistAdjustmentDockUI():
    ...
    if _twistAdjustmentDockWidget is None:
        ...
        if not cmds.workspaceControl(_twistAdjustmentDockName, q = True, exists = True):
            ...
            uiScript = "import MRS_FlexiInstancer_twistAdjustmentUIDock\nMRS_FlexiInstancer_twistAdjustmentUIDock.twistAdjustmentDockUIScript()"
