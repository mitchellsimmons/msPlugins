...
_twistAdjustmentDockName = "MRS_FlexiChainTriple_TwistAdjustmentUI_WorkspaceControl"
_twistAdjustmentWindowName = "MRS_FlexiChainTriple_TwistAjustmentUI"
...
def twistAdjustmentDockUI():
    ...
    if _twistAdjustmentDockWidget is None:
        ...
        if not cmds.workspaceControl(_twistAdjustmentDockName, q = True, exists = True):
            ...
            uiScript = "import MRS_FlexiChainTriple_twistAdjustmentUIDock\nMRS_FlexiChainTriple_twistAdjustmentUIDock.twistAdjustmentDockUIScript()"
