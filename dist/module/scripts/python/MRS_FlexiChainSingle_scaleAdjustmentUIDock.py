...
_scaleAdjustmentDockName = "MRS_FlexiChainSingle_ScaleAdjustmentUI_WorkspaceControl"
_scaleAdjustmentWindowName = "MRS_FlexiChainSingle_ScaleAjustmentUI"
...
def scaleAdjustmentDockUI():
    ...
    if _scaleAdjustmentDockWidget is None:
        ...
        if not cmds.workspaceControl(_scaleAdjustmentDockName, q = True, exists = True):
            ...
            uiScript = "import MRS_FlexiChainSingle_scaleAdjustmentUIDock\nMRS_FlexiChainSingle_scaleAdjustmentUIDock.scaleAdjustmentDockUIScript()"
