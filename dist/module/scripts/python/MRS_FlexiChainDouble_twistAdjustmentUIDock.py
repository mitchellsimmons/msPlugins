...
_twistAdjustmentDockName = "MRS_FlexiChainDouble_TwistAdjustmentUI_WorkspaceControl"
_twistAdjustmentWindowName = "MRS_FlexiChainDouble_TwistAjustmentUI"
...
def twistAdjustmentDockUI():
    ...
    if _twistAdjustmentDockWidget is None:
        ...
        if not cmds.workspaceControl(_twistAdjustmentDockName, q = True, exists = True):
            ...
            uiScript = "import MRS_FlexiChainDouble_twistAdjustmentUIDock\nMRS_FlexiChainDouble_twistAdjustmentUIDock.twistAdjustmentDockUIScript()"
